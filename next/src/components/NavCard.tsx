...
export function NavCard({
  ...
  return (
    <Link
      href={href}
      data-reveal
      className={`group relative flex flex-col gap-2 overflow-hidden ${panel} p-5 text-text no-underline transition-[border-color,background-color,box-shadow] duration-200 hover:bg-surface-2 card-glow-hover card-line-hover`}
    >
